...
<div id="layoutSidenav_content">
    ...
    <nav>
        <div class="mt-2 nav nav-tabs" id="nav-tab" role="tablist">
            <button class="ml-2 nav-link  @if((session()->get('errores')=="") && (session()->get('errorPass')=="")) active @endif" id="nav-info-tab" data-bs-toggle="tab" data-bs-target="#nav-info" type="button" role="tab" aria-controls="info" aria-selected="true"><div class="sb-nav-link-icon"><i class="fas fa-info-circle"></i></div>Información</button>
            <button class="nav-link  @if((session()->get('errores')!=""))active @endif" id="nav-edit-tab" data-bs-toggle="tab" data-bs-target="#nav-edit" type="button" role="tab" aria-controls="nav-files" aria-selected="false"><div class="sb-nav-link-icon"><i class="fas fa-tools"></i></div>Modificar</button>
            <button class="nav-link @if((session()->get('errorPass')!="")) active @endif" id="nav-pass-tab" data-bs-toggle="tab" data-bs-target="#nav-pass" type="button" role="tab" aria-controls="nav-tareas" aria-selected="false"><div class="sb-nav-link-icon"><i class="fas fa-lock"></i></div>Cambiar Contraseña</button>
        </div>
    </nav>
        <div class="tab-content" id="myTabContent">
            <div class="tab-pane fade @if((session()->get('errores')=="") && (session()->get('errorPass')=="")) show active @endif" id="nav-info" role="tabpanel" aria-labelledby="nav-info">
            ...
            <div class="tab-pane fade  @if((session()->get('errores')!="")) show active @endif" id="nav-edit" role="tabpanel" aria-labelledby="profile-tab">
            ...
            <div class="tab-pane fade  @if((session()->get('errorPass')!="")) show active @endif" id="nav-pass" role="tabpanel" aria-labelledby="pass-tab">
