    ...
    <div id="layoutSidenav_content">
        ...
        <nav>
            <div class="mt-2 nav nav-tabs" id="nav-tab" role="tablist">
                <button
                    class="ml-2 nav-link  @if((session()->get('errores')=="") && (session()->get('errorPass')=="")) active @endif"
                    id="nav-info-tab" data-bs-toggle="tab" data-bs-target="#nav-info" type="button" role="tab"
                    aria-controls="info" aria-selected="true">
                    <div class="sb-nav-link-icon"><i class="fas fa-info-circle"></i></div>
                    Información
                </button>
                <button class="nav-link  @if((session()->get('errores')!=""))active @endif" id="nav-edit-tab"
                        data-bs-toggle="tab" data-bs-target="#nav-edit" type="button" role="tab"
                        aria-controls="nav-files" aria-selected="false">
                    <div class="sb-nav-link-icon"><i class="fas fa-tools"></i></div>
                    Modificar
                </button>
                <button class="nav-link @if((session()->get('errorPass')!="")) active @endif" id="nav-pass-tab"
                        data-bs-toggle="tab" data-bs-target="#nav-pass" type="button" role="tab"
                        aria-controls="nav-tareas" aria-selected="false">
        ...
        <div class="tab-content" id="myTabContent">
            <div
                class="tab-pane fade @if((session()->get('errores')=="") && (session()->get('errorPass')=="")) show active @endif"
                id="nav-info" role="tabpanel" aria-labelledby="nav-info">
                ...
                <div class="mt-4 col-10 offset-1 col-sm-8 offset-sm-2 col-xl-6 offset-xl-3">
                    <div class="form-group row">
                        ...
                        <div class="col-8">
                            <input type="text" class="form-control text-muted" id="userMostrar"
            ...
            <div class="tab-pane fade  @if((session()->get('errores')!="")) show active @endif" id="nav-edit"
            ...
            <div class="tab-pane fade  @if((session()->get('errorPass')!="")) show active @endif" id="nav-pass"
                 role="tabpanel" aria-labelledby="pass-tab">
                <div class="mt-4 col-md-7 offset-md-3">
                    ...
                    <form class="user" method="POST" id="formulario2" action="{{route('cambiarContrasena')}}">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-6">
                                <input type="password" pattern="[A-Za-z0-9!?-_]{8,12}" id="currentPass"
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-6">
                                <input type="password" pattern="[A-Za-z0-9!?-_]{8,12}" id="pass" name="pass"
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-6">
                                <input type="password" pattern="[A-Za-z0-9!?-_]{8,12}" id="pass2" name="pass2"
                                       class="form-control" required>
                            </div>
                        </div>
                        ...
                        <div class="form-group text-center">
                            <div class="form-group mt-4 mb-0"><input type="submit"
                                                                     class="btn btn-primary btn-block"
                                                                     onclick="actualizarPass()"
                                                                     value="Crear cuenta"></div>
                        </div>
                    </form>
                </div>
            </div>
