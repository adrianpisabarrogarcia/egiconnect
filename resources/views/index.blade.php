...
@section('content')
    ...
    <div id="layoutSidenav_content">
        <main class="p-2">
            ...
            <div class="row d-flex justify-content-center align-center">
                <div class="col-12 col-sm-6 d-flex justify-content-center p-2 p-sm-5">
                    <button type="button" class="btn btn-outline-primary btn-lg w-100" data-bs-toggle="modal"
                            data-bs-target="#crear" data-bs-whatever="@getbootstrap"><i
                            class="fas fa-plus-circle"></i>&nbsp;&nbsp;CREAR PROYECTO
                    </button>
                </div>
                <div style="width: 100vw" class="modal fade" id="crear" tabindex="-1"
                                    ...
                                    <form>
                                        ...
                                        <div class="mb-3">
                                            ...
                                            <textarea style="resize: none" rows="5" class="form-control"
                                                      ...
                                                      placeholder="Escribe una breve descripcion del proyecto"
                                                      required></textarea>
                                        </div>
                                        <input type="hidden" name="codigo" id="codigo">
                                        <input type="hidden" name="idcreador" id="creador"
                ...
                <div class="col-12 col-sm-6 d-flex justify-content-center p-2 p-sm-5">
                    <button type="button" class="btn btn-outline-primary btn-lg w-100" data-bs-toggle="modal"
                            data-bs-target="#unirse" data-bs-whatever="@getbootstrap">
                        <i class="fas fa-unlock-alt"></i>&nbsp;&nbsp;UNIRTE
                        AL PROYECTO
                    </button>
                </div>
                <div style="width: 100vw" class="modal fade" id="unirse" tabindex="-1"
                     aria-labelledby="exampleModalLabel" aria-hidden="true">
                    <div class="modal-dialog">
                        <div class="modal-content">
                            <form class="proyecto" method="POST" id="formulario2" action="{{route('unirseProyecto')}}">
                                ...
                                <div class="modal-body">
                                    <form>
                                        <div class="mb-3">
                                            <label for="codigoProyecto" class="col-form-label">Codigo del
                                                proyecto:</label>
                                            <input style="text-transform: uppercase;" maxlength="5" minlength="5"
                                                   type="text" class="form-control" id="codigoProyecto"
                                                   name="codigoProyecto"
                                                   placeholder="Escribe el codigo del proyecto para unirte">
                                        </div>
                                ...
                                <div class="modal-footer">
                                    ...
                                    <button type="button" id="botonUnirseProyecto" class="btn btn-primary">Unirse
                                    </button>
                                </div>
                            </form>
                        </div>
            ...
            @endif
            <?php $ultimosMensajes = session()->get('ultimosMensajes');
            $contador = 8;
            if (count($ultimosMensajes) < $contador) {
                $contador = count($ultimosMensajes);
            }
            ?>
            ...
            @if(count($ultimosMensajes) !=0)
                <div class="row d-flex justify-content-evenly p-4">
                    ...
                    <div class="col-12 col-sm-6 col-md-4 col-lg-3 tarjetasinicio">
                        <a href="/proyecto/{{$ultimosMensajes[$i]->idproy}}">
                            <div class="card text-dark bg-light mb-3 ">
                                <div class="card-header">{{ $ultimosMensajes[$i]->nombreproy }}</div>
                                <div class="card-body">
                                    <h5 class="card-title"><i
                                            class="fas fa-reply"></i>&nbsp;&nbsp;{{ $ultimosMensajes[$i]->nombreusu }}:
                                    </h5>
                                    <p class="card-text">{{ $ultimosMensajes[$i]->descripcion }}</p>
                                </div>
                            </div>
                        </a>
                    </div>
            ...
            @else
                <div class="row">
                    <p class="text-center">No hay últimos mensajes para mostrar</p>
                </div>
            @endif
        </main>
        @endsection
