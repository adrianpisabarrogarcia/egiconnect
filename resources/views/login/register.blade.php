                    ...
                    <div class="row justify-content-center">
                        <div class="col-lg-7">
                            <div class="card shadow-lg border-0 rounded-lg mt-5">
                                <div class="card-header"><h3 class="text-center font-weight-light my-4">Crea tu
                                        cuenta</h3>
                                </div>
                                <div class="card-body">
                                    <form action="{{route('registro.enter')}}" method="POST">
                                        @csrf
                                        <div class="form-row">
                                            <div class="col-md-6">
                                        ...
                                        @if(isset($errores))
                                            <div class='alert alert-danger text-center' role='alert'>{!! $errores !!}</div>
                                        @endif
